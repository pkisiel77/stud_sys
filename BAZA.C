...
shint baza_blankiet(shint nr_rekordu, shint ob_pocz,
...
char *dane_baza(shint ob_pocz, shint ob_konc, shint *rozmiar_ob)
 {
...
void wpis_baza(shint ob_pocz, shint ob_konc, char *D, shint rozmiar_ob, char zapis[], char *Kod_op) {;}
shint dec_baza(shint decyzja, shint kod_decyzji, shint nr_dec, shint kod_uslugi, shint np, shint *nr_rekordu)
 {
	struct agenda *A0, *A;
	struct oblicz *Ob;
