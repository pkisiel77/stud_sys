...
void wpis_baza(int ob_pocz, int ob_konc, char *D, int rozmiar_ob, char zapis[], char *Kod_op) {;}
int dec_baza(int decyzja, int kod_decyzji, int nr_dec, int kod_uslugi, int np, int *nr_rekordu)
 {
	struct agenda *A0, *A;
	struct oblicz *Ob;
