...
int raporty(signed char Kod_uslugi, shint Nr_rekordu, shint npzl,
 ...
 {shint ret, max_l_data_blank;       /*liczba danych obslugiwana przez bl */
	shint y_gorny, x_lewy=0, y_danej, y_dolny, x_prawy;
	shint decyzja,  kod_decyzji, nr_dec, nr_rekordu, p_konc, i;
	shint old_raport, old_rekord, j, np=0;
